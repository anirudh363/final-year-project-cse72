...
const EditFacultyForm = ({ onEditFaculty, setShowForm, currentFaculty, timeSlots }) => {
  // Initialize state with the current faculty data
  const [facultyData, setFacultyData] = useState(currentFaculty);
...
//   const timeSlots = ["9AM", "12PM", "3PM"];
  ...
  const handleSubmit = (e) => {
    ...
    if (facultyData.name.trim()) {
      ...
      onEditFaculty(sanitizedData); // Pass sanitized data to parent
